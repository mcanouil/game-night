...
<!-- badges: start -->
![License](https://img.shields.io/github/license/mcanouil/game-night?style=plastic)
<!-- badges: end -->
...
outdated <- !file.exists(thumb) |
  file.mtime(thumb) < file.mtime(rscript) |
  file.mtime(thumb) < file.mtime("assets/social.R")
...
img <- glue::glue('<img alt="Poster for {posters} game night" src="{thumb}" width="192" height="108" />')

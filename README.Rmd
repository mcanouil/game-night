...
past_posters <- TRUE#as.Date(posters) > Sys.Date()
unlink(dirname(png)[!past_posters], recursive = TRUE)

invisible(lapply(rscript[past_posters & outdated], source, encoding = "UTF-8"))
